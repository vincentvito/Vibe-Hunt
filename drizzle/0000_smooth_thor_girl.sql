CREATE TYPE "public"."asset_type" AS ENUM('full_ip', 'codebase_only', 'assets_only', 'codebase_and_assets', 'license_only');--> statement-breakpoint
CREATE TYPE "public"."bid_status" AS ENUM('pending', 'accepted', 'rejected', 'withdrawn');--> statement-breakpoint
CREATE TYPE "public"."bounty_status" AS ENUM('open', 'in_progress', 'completed', 'cancelled', 'expired');--> statement-breakpoint
CREATE TYPE "public"."game_engine" AS ENUM('unity_webgl', 'godot_web', 'custom_wasm', 'html5_canvas', 'playcanvas', 'phaserjs', 'threejs', 'other');--> statement-breakpoint
CREATE TYPE "public"."game_status" AS ENUM('draft', 'in_review', 'published', 'archived', 'suspended');--> statement-breakpoint
CREATE TYPE "public"."license_type" AS ENUM('free', 'attribution', 'commercial', 'restricted');--> statement-breakpoint
CREATE TYPE "public"."listing_status" AS ENUM('draft', 'active', 'under_offer', 'sold', 'withdrawn');--> statement-breakpoint
CREATE TYPE "public"."notification_type" AS ENUM('upvote', 'comment', 'comment_reply', 'new_follower', 'offer_received', 'offer_accepted', 'offer_rejected', 'escrow_released', 'bounty_bid', 'bounty_accepted', 'daily_featured', 'remix_created');--> statement-breakpoint
CREATE TYPE "public"."offer_status" AS ENUM('pending', 'accepted', 'rejected', 'countered', 'in_escrow', 'escrow_released', 'disputed', 'cancelled', 'expired');--> statement-breakpoint
CREATE TYPE "public"."prompt_source" AS ENUM('cursor', 'claude', 'chatgpt', 'copilot', 'v0', 'bolt', 'replit', 'windsurf', 'other');--> statement-breakpoint
CREATE TYPE "public"."user_role" AS ENUM('creator', 'buyer', 'admin');--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "bounties" ADD CONSTRAINT "bounties_requester_id_users_id_fk" FOREIGN KEY ("requester_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "bounty_bids" ADD CONSTRAINT "bounty_bids_bounty_id_bounties_id_fk" FOREIGN KEY ("bounty_id") REFERENCES "public"."bounties"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "bounty_bids" ADD CONSTRAINT "bounty_bids_bidder_id_users_id_fk" FOREIGN KEY ("bidder_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "daily_features" ADD CONSTRAINT "daily_features_game_id_games_id_fk" FOREIGN KEY ("game_id") REFERENCES "public"."games"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "listings" ADD CONSTRAINT "listings_game_id_games_id_fk" FOREIGN KEY ("game_id") REFERENCES "public"."games"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "prompt_histories" ADD CONSTRAINT "prompt_histories_game_id_games_id_fk" FOREIGN KEY ("game_id") REFERENCES "public"."games"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "prompt_histories" ADD CONSTRAINT "prompt_histories_uploader_id_users_id_fk" FOREIGN KEY ("uploader_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "template_licenses" ADD CONSTRAINT "template_licenses_game_id_games_id_fk" FOREIGN KEY ("game_id") REFERENCES "public"."games"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "template_purchases" ADD CONSTRAINT "template_purchases_license_id_template_licenses_id_fk" FOREIGN KEY ("license_id") REFERENCES "public"."template_licenses"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "upvotes" ADD CONSTRAINT "upvotes_game_id_games_id_fk" FOREIGN KEY ("game_id") REFERENCES "public"."games"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "bounties_status_created_idx" ON "bounties" USING btree ("status","created_at");--> statement-breakpoint
CREATE INDEX "bounties_requester_id_idx" ON "bounties" USING btree ("requester_id");--> statement-breakpoint
CREATE INDEX "bounty_bids_bounty_status_idx" ON "bounty_bids" USING btree ("bounty_id","status");--> statement-breakpoint
CREATE INDEX "comments_game_created_idx" ON "comments" USING btree ("game_id","created_at");--> statement-breakpoint
CREATE INDEX "comments_parent_id_idx" ON "comments" USING btree ("parent_id");--> statement-breakpoint
CREATE INDEX "daily_features_date_rank_idx" ON "daily_features" USING btree ("date","rank");--> statement-breakpoint
CREATE INDEX "follows_following_id_idx" ON "follows" USING btree ("following_id");--> statement-breakpoint
CREATE INDEX "game_stats_game_date_idx" ON "game_stats" USING btree ("game_id","date");--> statement-breakpoint
CREATE INDEX "games_creator_id_idx" ON "games" USING btree ("creator_id");--> statement-breakpoint
CREATE INDEX "games_status_launch_idx" ON "games" USING btree ("status","launch_date");--> statement-breakpoint
CREATE UNIQUE INDEX "games_slug_idx" ON "games" USING btree ("slug");--> statement-breakpoint
CREATE INDEX "games_upvote_count_idx" ON "games" USING btree ("upvote_count");--> statement-breakpoint
CREATE INDEX "listings_status_price_idx" ON "listings" USING btree ("status","asking_price");--> statement-breakpoint
...
CREATE INDEX "offers_listing_status_idx" ON "offers" USING btree ("listing_id","status");--> statement-breakpoint
...
CREATE INDEX "prompt_histories_game_sort_idx" ON "prompt_histories" USING btree ("game_id","sort_order");--> statement-breakpoint
CREATE UNIQUE INDEX "tags_slug_idx" ON "tags" USING btree ("slug");--> statement-breakpoint
CREATE INDEX "upvotes_game_date_idx" ON "upvotes" USING btree ("game_id","date");--> statement-breakpoint
